-- install.lua
-- Telecharge (ou met a jour) l'app adboard_display dans /adboard_display/,
-- installe ses libs partagees dans /lib/, et se met a jour lui-meme.
-- A executer depuis le shell CraftOS sur le computer :
...
local APP_RAW = REPO_RAW .. "apps/adboard_display/"

local TARGET_DIR = "/adboard_display"
